...
```cpp
const char* ssid     = "YOUR_WIFI_SSID";      // Kendi Wi-Fi adınızı girin
const char* password = "YOUR_WIFI_PASSWORD";  // Kendi Wi-Fi şifrenizi girin
const char* apiBase  = "http://AgentJee.local:8000";
const char* apiKey   = "YOUR_API_KEY";         // HomeAgent .env dosyasındaki API_KEY ile eşleşmeli
```
