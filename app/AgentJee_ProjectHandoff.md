...
```
/home/serhanensar/pi-panel/          ← Ana proje dizini (Raspberry Pi üzerinde)
├── app/
...
Varsayılan şifre: `changeme` (ilk kurulumda, sonradan değiştirilmeli)
...
```
/home/serhanensar/pi-panel/app/telegram_state.txt
```
...
```json
{
  ...
  "remotePath": "/home/serhanensar/pi-panel",
  "uploadOnSave": true,
  "useTempFile": false,
  "openSsh": false
}
...
- İlk kurulumda default şifre: `changeme` → Profile sayfasından değiştirilmeli
...
| FastAPI - `/api/info` | ❌ Yok | ESP32 settings için kullanılıyor |
